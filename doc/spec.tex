...
\]
when $i$ is an identifier, $e_i$ ($0 \le i \le n$) is an expression and $m$ is a message-info.
...
A \textit{block} is a sequence of stentences surrounded by \texttt{\{} and \texttt{\}}.
