...
val realize_pseudo_instruction :
  post_layout_info -> Assoc.contract_id -> PseudoImm.pseudo_imm Evm.instruction -> Wrap_bn.t Evm.instruction

val realize_pseudo_program :
  post_layout_info -> Assoc.contract_id -> PseudoImm.pseudo_imm Evm.program -> Wrap_bn.t Evm.program

val layout_info_of_contract : Syntax.typ Syntax.contract -> PseudoImm.pseudo_imm Evm.program (* constructor *) -> contract_layout_info

val realize_pseudo_imm : post_layout_info -> Assoc.contract_id -> PseudoImm.pseudo_imm -> Wrap_bn.t
