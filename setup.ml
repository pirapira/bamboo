...
(* OASIS_START *)
(* DO NOT EDIT (digest: dbc1195d429c3d76fa937b17d6aaf092) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/parse";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ast"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "bbo.ml"})
            ];
     ...
     oasis_digest =
       Some "\197\212~\189]\236\005\178\201\2148\216\216\003\1635";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
