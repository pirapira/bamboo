...
bbo:
	ocamlbuild -use-ocamlfind -Is src/ast,src/parse,src/lib,src/codegen,src/basics -package batteries -package cryptokit -package rope -package hex -use-menhir -cflag -warn-error -cflag A src/exec/bbo.native
